                ...
                <div class="row" id="warea">
                    <div class="col-12 m-record" id="moreRcd">
                        <div style="background: linear-gradient(180deg,#fe6868 0%,#ff8e8a 100%);" class="row nav-top">
                            <div class="col-12">
                                <div class="row">
                                    <div class="col-2 xtl"><span class="nav-back wt" id="backF"
                                            onclick="window.location.href='{{route('account')}}';"></span></div>
                                    <div class="col-10 pl-0 xtl"><span class="tf-18 tfs-w" id="MoreRCT">Withdraw
                                            Record</span></div>
                                </div>
                            </div>
                        </div>
