...
@section('content')
            ...
            <div data-v-4c21fa9e="" class="navbar-fixed" style="background: rgb(247, 248, 255);">
                <div data-v-4c21fa9e="" class="navbar__content">
                    ...
                    <div data-v-4c21fa9e="" class="navbar__content-center">
                        <img data-v-3d31d6c1="" src="./favicon.png" alt="">
                    </div>
                    <div data-v-4c21fa9e="" class="navbar__content-right"></div>
                </div>
            </div>
        </div>
        <div data-v-adddb413="" data-v-3d31d6c1="" class="infiniteScroll"
            style="--36a344b0: 'Roboto', 'Inter', sans-serif;">
            <div data-v-513662bd="" data-v-3d31d6c1="" class="activitySection__container">


                @foreach ($activity as $item)
                    <div onclick="window.location.href='{{ route($item->route) }}';" data-v-513662bd="" class="box">
                        <img data-v-513662bd="" src="{{asset($item->image )}}" class="act_0">
                        <div data-v-513662bd="" class="box-content">
                            <h1 data-v-513662bd="">{{ $item->title }}</h1>
                        </div>
                    </div>
                @endforeach
        ...
        <div data-v-67fe8f9c="" class="tabbar__container" style="--36a344b0: 'Roboto', 'Inter', sans-serif;">
            <div data-v-67fe8f9c="" onclick="window.location.href='{{ route('home') }}';" class="tabbar__container-item ">
            ...
            <div data-v-67fe8f9c="" onclick="window.location.href='{{ route('wallet') }}';" class="tabbar__container-item">
                <svg data-v-67fe8f9c="" xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="none"
