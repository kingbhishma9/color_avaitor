...
@section('content')
    <div id="app" data-v-app=""><!----><!---->
        <div data-v-4c21fa9e="" data-v-3d31d6c1="" class="navbar" style="--36a344b0: 'Roboto', 'Inter', sans-serif;">
            <div data-v-4c21fa9e="" class="navbar-fixed" style="background: rgb(247, 248, 255);">
                <div data-v-4c21fa9e="" class="navbar__content">
                    ...
                    <div data-v-4c21fa9e="" class="navbar__content-center"><!----><img data-v-3d31d6c1=""
                            src="./favicon.png" alt=""></div>
                    <div data-v-4c21fa9e="" class="navbar__content-right"></div>
                </div>
            </div>
        </div>
        <div data-v-adddb413="" data-v-3d31d6c1="" class="infiniteScroll" id="refresh3bc4e9947fbe4ca9a5a6ca9a6d66d2a5"
            style="--36a344b0: 'Roboto', 'Inter', sans-serif;">
            <div data-v-513662bd="" data-v-3d31d6c1="" class="activitySection__container">
                <div onclick="window.location.href='/recharge#/';" data-v-513662bd="" class="box"><img data-v-513662bd=""
                        src="https://ossimg.91admin123admin.com/91club/banner/Banner_20230611110711jaex.png" class="act_0">
                    <div data-v-513662bd="" class="box-content">
                        <h1 data-v-513662bd="">Deposit and Get Bonus Check-in</h1>
                    </div>
                </div>
                <div data-v-513662bd="" style="display:none;" class="box"><img data-v-513662bd=""
                        src="https://ossimg.91admin123admin.com/91club/banner/Banner_20230615171653i2s9.jpg" class="act_1">
                    <div data-v-513662bd="" class="box-content">
                        <h1 data-v-513662bd="">Bonus Winning Streak</h1>
                    </div>
                </div>
                <div data-v-513662bd="" style="display:none;" class="box"><img data-v-513662bd=""
                        src="https://ossimg.91admin123admin.com/91club/banner/Banner_20230615171900e3bc.jpg" class="act_2">
                    <div data-v-513662bd="" class="box-content">
                        <h1 data-v-513662bd="">Complete Awesome Rewarded Missions</h1>
                    </div>
                </div>
                <div data-v-513662bd="" style="display:none;" class="box"><img data-v-513662bd=""
                        src="https://ossimg.91admin123admin.com/91club/banner/Banner_20230615172059etie.jpg" class="act_3">
                    <div data-v-513662bd="" class="box-content">
                        <h1 data-v-513662bd="">" Loss Bonus " - Turn Losses Into Wins</h1>
                    </div>
                </div>
                <div data-v-513662bd="" style="display:none;" class="box"><img data-v-513662bd=""
                        src="https://ossimg.91admin123admin.com/91club/banner/Banner_20230615172319qg3h.jpg" class="act_4">
                    <div data-v-513662bd="" class="box-content">
                        <h1 data-v-513662bd="">Monthly Bonus Promotion</h1>
                    </div>
                </div>
                <div data-v-513662bd="" style="display:none;" class="box"><img data-v-513662bd=""
                        src="https://ossimg.91admin123admin.com/91club/banner/Banner_20230615172451icpw.jpg" class="act_5">
                    <div data-v-513662bd="" class="box-content">
                        <h1 data-v-513662bd="">Play Wingo Get Super Bonuses</h1>
                    </div>
                </div>
                <div data-v-513662bd="" style="display:none;" class="box"><img data-v-513662bd=""
                        src="https://ossimg.91admin123admin.com/91club/banner/Banner_202308111639363cbt.jpg" class="act_6">
                    <div data-v-513662bd="" class="box-content">
                        <h1 data-v-513662bd="">Aviator High Betting Reward</h1>
                    </div>
                </div>
                <div data-v-513662bd="" style="display:none;" class="box"><img data-v-513662bd=""
                        src="https://ossimg.91admin123admin.com/91club/banner/Banner_20230615171303xhpa.jpg" class="act_7">
                    <div data-v-513662bd="" class="box-content">
                        <h1 data-v-513662bd="">Youtube Creative Video</h1>
                    </div>
                </div>
            </div>
            <div data-v-adddb413="" class="infiniteScroll__loading"><!---->
                <div data-v-adddb413="">No more</div>
            </div>
        </div><br data-v-3d31d6c1="" style="--36a344b0: 'Roboto', 'Inter', sans-serif;">
        <br data-v-3d31d6c1=""
            style="--36a344b0: 'Roboto', 'Inter', sans-serif;">
            <br data-v-3d31d6c1=""
            style="--36a344b0: 'Roboto', 'Inter', sans-serif;">
        ...
        <div data-v-67fe8f9c="" class="tabbar__container" style="--36a344b0: 'Roboto', 'Inter', sans-serif;">
            ...
            <div data-v-67fe8f9c="" class="tabbar__container-item active"
    ...
    <div role="dialog" tabindex="0"
        ...
        style="z-index: 2002; display: none;"><i
            class="van-badge__wrapper van-icon van-icon-fail van-toast__icon"><!----><!----><!----></i>
        <div class="van-toast__text">Error: 502
            The deposit amount does not meet the standard</div><!---->
    </div>
@endsection
