...
@section('content')
        ...
        <div data-v-4c21fa9e="" data-v-3cbb9e12="" class="navbar">
            <div data-v-4c21fa9e="" class="navbar-fixed" style="background: rgb(247, 248, 255);">
                <div data-v-4c21fa9e="" class="navbar__content">
                    ...
                    <div data-v-4c21fa9e="" class="navbar__content-right" style="display:none;"><span
                            data-v-3cbb9e12="">Withdrawal history</span></div>
                </div>
            </div>
        </div>
        <div data-v-3cbb9e12="" class="withdraw__container-content">
            <div data-v-dabc66b0="" data-v-3cbb9e12="" class="balanceAssets">
                <div data-v-dabc66b0="" class="balanceAssets__header">
                    <div data-v-dabc66b0="" class="balanceAssets__header__left"><img data-v-dabc66b0=""
                ...
                <div data-v-dabc66b0="" class="balanceAssets__main">
                    <p data-v-dabc66b0="">₹1</p><img data-v-dabc66b0=""
                ...
                <div data-v-dabc66b0="" class="balanceAssets__tip"><img data-v-dabc66b0=""
                        src="https://91clubin.in/assets/png/cip-7ed1a634.png" alt=""></div>
            </div>
            <div data-v-13d33537="" data-v-3cbb9e12="" class="withdrawWay">
                <div data-v-13d33537="" class="select">
                    <div data-v-13d33537=""><img data-v-13d33537=""
                            src="https://ossimg.91admin123admin.com/91club/payNameIcon/WithBeforeImgIcon2_20230912183258ejvp.png">
                    </div><span data-v-13d33537=""> BANK CARD</span>
                </div>
                {{-- <div data-v-13d33537="" onclick="window.location.href='/USDTPAYOUT#/'" class="">
                    <div data-v-13d33537=""><img data-v-13d33537=""
                            src="https://ossimg.91admin123admin.com/91club/payNameIcon/WithBeforeImgIcon_20230912183344vmsx.png">
                    </div><span data-v-13d33537="">USDT</span>
                </div> --}}
            </div>
            <div data-v-3cbb9e12="" class="bankInfo">
                <div data-v-3cbb9e12="" class="bankInfoItem">
                    <div data-v-3cbb9e12=""><img data-v-3cbb9e12=""
                            src="https://91clubin.in/assets/png/1-4618686f.png"><span data-v-3cbb9e12=""></span></div>
                    <div data-v-3cbb9e12=""><span data-v-3cbb9e12=""></span><span data-v-3cbb9e12="">ADD BANK / USDT</span>
                    </div><i data-v-3cbb9e12="" class="van-badge__wrapper van-icon van-icon-arrow"></i>
                </div>
            </div>
            <div class="row mt-4 mb-4">
                <div style="display:none;" class="col-12">
                    <div class="row" id="bcard">
                        <div class="col-12 xtl tf-24 tfw-7 pl-0"><span
                                style="background: #0487E2;color: #fff;padding: 0 10px;border-radius: 6px;">Bank<span></span></span>
                        </div>
                    ...
                    <div class="pt-2 xtr"><span class="mcpl tfcdg" onclick="window.location.href='bankcard#'">Change
                            &gt;</span></div>
                </div>
                <div class="col-12" id="add">
                    <div data-v-fbdbcf8d="" onclick="window.location.href='addbank#'" data-v-3cbb9e12=""
                        class="addWithdrawType">
                        <div data-v-fbdbcf8d="" class="addWithdrawType-top"><img data-v-fbdbcf8d=""
                                ...
                                data-v-fbdbcf8d="">Add a bank account number</span></div>
                        <div data-v-fbdbcf8d="" class="addWithdrawType-text">Need to add beneficiary information to be
                            able to withdraw money</div>
                    </div>
                    <div class="row" style="display:none;" id="bcard">
                        <div class="col-12 pt-4 pb-4 tf-20 mcpl"><span class="add"></span><span id="wpid">Add
                                BankCard</span></div>
                    </div>
                </div>
                <form action="sub.php" id="wform" method="post">
            </div>
            <div data-v-fbdbcf8d="" data-v-3cbb9e12="" style="display:none;" class="addWithdrawType">
                <div data-v-fbdbcf8d="" class="addWithdrawType-top"><img data-v-fbdbcf8d=""
                        src="data:image/png;base64,"><span
                        data-v-fbdbcf8d="">Add a bank account number</span></div>
                <div data-v-fbdbcf8d="" class="addWithdrawType-text">Need to add beneficiary information to be able to
                    withdraw money</div>
            </div>
            <div data-v-eee9adef="" class="explain" style="">
                <div data-v-eee9adef="" class="input">
                    <div data-v-eee9adef="" class="place-div">₹</div><input data-v-eee9adef=""
                        placeholder="Please enter the amount" autocomplete="off" type="tel" maxlength="5"
                        id="withdraw" name="withdraw" class="inp">
                </div>
                <div data-v-eee9adef="" class="input">
                ...
                <div data-v-eee9adef="" class="balance bank">
                    <div data-v-eee9adef="">
                        <span data-v-eee9adef="">Withdrawable balance <h6 data-v-eee9adef="" class="red">₹1</h6>
                        </span>
                        <input data-v-eee9adef="" type="button" value="All">
                    </div>
                    <div data-v-eee9adef=""><span data-v-eee9adef="">Withdrawal amount received</span>
                        <div data-v-eee9adef="" class="rightD">
                            <span data-v-eee9adef="" class="yellow">₹<span id="famount">0</span>.00</span>
                        </div>
                    </div>
                </div>
            </div>
            <div data-v-eee9adef="" class="explain usdt" style="display: none;">
                <div data-v-eee9adef="" class="head">
                    <img data-v-eee9adef="" src="https://91clubin.in/assets/png/1-bcd21d34.png">
                </div>
                <div data-v-eee9adef="" class="input">
                    <div data-v-eee9adef="" class="place-div">₹</div>
                    <input data-v-eee9adef="" type="number" placeholder="Please enter withdrawal amount"
                        class="inp">
                </div>
                <div data-v-eee9adef="" class="balance usdt">
                    <div data-v-eee9adef=""><span data-v-eee9adef="">Withdrawable balance <h6 data-v-eee9adef=""
                                class="yellow">₹</h6></span>
                        <input data-v-eee9adef="" type="button" value="All">
                    </div>
                </div>
            </div>
            <div data-v-3cbb9e12="" class="recycleBtnD">
                <button data-v-3cbb9e12="" onclick="sub()" class="recycleBtn active">Withdraw</button>
                </form>
            </div>
            <div data-v-699510fe="" data-v-3cbb9e12="" class="Recharge__container-intro">
                <p data-v-699510fe="">Need to bet <span data-v-470caa86="" class="red">₹0.00</span> to be able to
                    withdraw</p>
                <p data-v-699510fe="">Withdraw time <span data-v-699510fe="" class="red">00:05-23:55</span>
                </p>
                <p data-v-699510fe="">Withdraw fee is only <span data-v-699510fe="" class="red">₹<span
                            id="fee">30</span>.00</span> for all ₹ withdrawal</p>
                <p data-v-699510fe="">Inday Remaining Withdrawal Times<span data-v-699510fe="" class="red"> 3</span>
                </p>
                <p data-v-699510fe="">Withdrawal amount range <span data-v-699510fe=""
                        class="red">₹180.00-₹1,000,000.00</span></p>
            </div>
            <div data-v-fda53fc1="" data-v-3cbb9e12="" class="rechargeh__container" style="display:none;">
                <div data-v-fda53fc1="" class="rechargeh__container-head">
                    <img data-v-fda53fc1=""
                    ...
                    <h1 data-v-fda53fc1="">Withdrawal history</h1>
                </div>
                <div data-v-fda53fc1="" class="rechargeh__container-content">
                    <div data-v-91f2fefc="" data-v-fda53fc1="" class="empty__container">
                        <img data-v-91f2fefc=""
                            alt="" class="" data-origin="https://91clubin.in/assets/png/empty-4ac9a431.png"
                            src="https://91clubin.in/assets/png/empty-4ac9a431.png">
                        <p data-v-91f2fefc="">No data</p>
                    </div>
                </div>
                <div data-v-fda53fc1="" class="rechargeh__container-footer">
                    <button data-v-fda53fc1="">All
                        history</button></div>
            </div>
        </div>
    </div>
    <div class="customer" id="customerId" style="--36a344b0: 'Roboto', 'Inter', sans-serif; --17a7a9f6: bahnschrift;">
        <img onclick="window.location.href='/keFuMenu#/'" class=""
            ...
            if (ADD BANK / USDT == "1111111111") {
                ...
                if (1000 == "0" || 1000 == "") {
                    ...
                    if (0 <= 0) {
                        ...
                        var y = document.getElementById("copied");
                        y.innerHTML = "you to bet 0  more to withdraw";
                        document.getElementById('copied').style.display = '';
                        setTimeout(function() {
                            document.getElementById('copied').style.display = 'none';
                        }, 3000);
            ...
            if (ADD BANK / USDT == "") {
                ...
                if (false) {
                    ...
                    if (0 >= 0) {
                        ...
                        if (x < 179) {
                            var y = document.getElementById("copied");
                            y.innerHTML = "Minimum withdraw 180";
                            y.className = "show";
                            setTimeout(function() {
                                y.className = y.className.replace("show", "");
                            }, 3000);
    ...
    <script>
        if (ADD BANK / USDT == "account") {
            document.getElementById("bank").innerHTML = "Add Bankcard To Withdraw";

        } else {
            document.getElementById("bank").innerHTML = "ADD BANK / USDT";
        }
    </script>
    <script>
        ...
        function confirm0() {
            ...
            document.getElementById("acc").innerHTML = "ADD BANK / USDT";
        }
