...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/index-f3c80c83.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/css/page-main-8cf260fb.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/css/page-home-684a3a25.css') }}">


    <link rel="stylesheet" href="{{ asset('assets/css/modules-96f5a6e8.css') }}">

    <link rel="stylesheet" href="{{ asset('assets/css/page-test-b38d710a.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/css/page-promotion-24bf6ab6.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/css/page-wallet-24fc13b6.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/win_files/index.e18c94d4.css') }}">
...
<body style="font-size: 12px;">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
            ...
            <defs>
                <filter id="filter0_d_1701_36307" x="-4" y="3" width="46" height="46"
                    ...
                    <feColorMatrix type="matrix"
                        values="0 0 0 0 0.552941 0 0 0 0 0.172549 0 0 0 0 0.172549 0 0 0 0.25 0">
                    </feColorMatrix>
        ...
        <symbol id="icon-changlong" viewBox="0 0 110 110" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <mask id="mask0_234_67307" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="8" y="3" width="98"
                height="101">
                <path fill-rule="evenodd" clip-rule="evenodd"
                    d="M27.2127 22.7154C20.9535 27.0685 10.3928 38.0529 8.51501 54.2338C6.06343 75.3592 20.7729 99.4571 46.3545 103.385C66.8198 106.527 82.3109 94.5738 87.4983 88.2044C99.01 72.9176 97.7309 60.2849 97.7309 60.2849C97.7309 60.2849 96.5584 66.7604 92.0816 70.5822C86.5846 75.2749 82.7017 75.3593 81.849 75.3593C79.5395 73.4838 73.5989 68.6925 67.8857 65.805C60.7441 62.1956 50.1917 56.1446 50.5115 50.1999C50.8341 44.2033 56.5871 41.6011 66.7132 42.3442C67.033 42.3677 64.5814 46.8026 62.1298 48.8197C66.429 49.3859 76.2637 50.943 79.9304 53.9154C83.5971 56.8878 82.7372 59.4002 81.849 60.2849C82.9504 60.3556 85.7289 60.1362 88.0312 58.6925C90.3335 57.2487 91.4776 55.5432 91.7619 54.8708C90.8381 55.2601 88.7987 55.7201 88.0312 54.4462C87.2638 53.1723 87.4272 51.9338 87.6048 51.4738C84.4071 51.0845 78.3102 49.5842 79.504 46.6967C80.9963 43.0873 85.2599 42.9811 86.6455 43.4058C88.0312 43.8304 90.696 44.892 91.0157 50.6245C91.028 50.8438 91.3137 50.6318 91.8062 50.2665C92.9475 49.4199 95.1993 47.7495 97.7309 48.7137C99.5429 49.4037 99.2587 53.3138 97.7309 54.4462C99.5429 54.0923 104.233 51.686 105.405 45.9536C105.492 45.5296 105.076 45.4781 104.251 45.3761C102.851 45.2027 100.273 44.8837 96.9848 42.3442C92.8064 39.117 91.6197 38.1687 91.5487 38.0979L91.7619 34.17C91.328 33.8937 90.8607 33.5972 90.3688 33.2851C86.3885 30.76 80.798 27.2134 78.3315 25.0405C75.8009 22.8111 70.4438 16.4416 68.9516 3.91506C68.6652 1.51115 67.6725 17.1848 71.0205 23.7666C71.6774 25.0581 57.5901 12.7262 55.7781 7.20595C55.7093 6.99642 56.9069 15.0616 62.4496 22.3865C63.0004 23.1144 62.0893 22.9956 60.1669 22.7449C56.2017 22.2277 47.9341 21.1493 39.3195 25.7836C24.7167 33.6393 23.5442 47.8644 24.7167 54.4462C25.5677 59.2233 27.2749 65.9112 36.1218 74.6162C38.0053 76.4694 32.6044 81.3041 23.4376 75.3593C18.1081 71.903 12.2457 66.3358 13.3116 51.4738C14.4387 35.7572 24.0384 25.2296 27.2127 22.7154ZM80.7831 32.8961L88.0312 36.2931L85.3665 37.8855C84.8335 37.1424 83.5971 35.4863 82.9149 34.8069C82.2327 34.1275 81.2094 33.2499 80.7831 32.8961Z"
            ...
            <defs>
                ...
                <linearGradient id="paint0_linear_234_67307" x1="56.8333" y1="3.66666" x2="56.8333"
                    y2="103.902" gradientUnits="userSpaceOnUse">
                    <stop stop-color="#FF7F79"></stop>
                    <stop offset="1" stop-color="#FB4B4B"></stop>
                </linearGradient>
                <linearGradient id="paint1_linear_234_67307" x1="56.8333" y1="3.66666" x2="56.8333"
                    y2="103.902" gradientUnits="userSpaceOnUse">
                    <stop stop-color="#FF736D"></stop>
                    <stop offset="1" stop-color="#F73E46"></stop>
                </linearGradient>
                <linearGradient id="paint2_linear_234_67307" x1="64.4833" y1="40.4526" x2="64.4833"
                    y2="100.833" gradientUnits="userSpaceOnUse">
                    <stop stop-color="#F3464A"></stop>
                    <stop offset="1" stop-color="#FFAA96"></stop>
                </linearGradient>
                <linearGradient id="paint3_linear_234_67307" x1="98.3367" y1="61.3072" x2="88.0919"
                    y2="86.5664" gradientUnits="userSpaceOnUse">
                    <stop stop-color="#FF9C8B"></stop>
                    <stop offset="1" stop-color="#F7434A"></stop>
                </linearGradient>
                <linearGradient id="paint4_linear_234_67307" x1="30.2404" y1="22.0772" x2="30.2404"
                    y2="102.879" gradientUnits="userSpaceOnUse">
        ...
        <symbol id="icon-JDB" viewBox="0 0 100 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <defs>
                <filter id="filter0_d_1701_36297" x="-4" y="6" width="66" height="41"
                    ...
                    <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_1701_36297" result="shape">
                    </feBlend>
                </filter>
        ...
        <symbol id="icon-JILI" viewBox="0 0 100 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <defs>
                <filter id="filter0_d_1701_36358" x="-4" y="5" width="98" height="42"
                    ...
                    <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_1701_36358" result="shape">
                    </feBlend>
                </filter>
        ...
        <symbol id="icon-MG" viewBox="0 0 100 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <defs>
                <filter id="filter0_d_1701_36291" x="-4" y="3" width="46" height="46"
                    ...
                    <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_1701_36291" result="shape">
                    </feBlend>
                </filter>
        ...
        <symbol id="icon-SEXY" viewBox="0 0 90 47" fill="none" xmlns="http://www.w3.org/2000/svg"
            ...
            <defs>
                <filter id="filter0_d_1668_26851" x="-2" y="-1" width="92" height="48"
                    ...
                    <feComposite in2="hardAlpha" operator="out"></feComposite>
                    <feColorMatrix type="matrix"
                        values="0 0 0 0 0.966667 0 0 0 0 0.433319 0 0 0 0 0.39875 0 0 0 1 0">
                    </feColorMatrix>
                ...
                <pattern id="pattern0" patternContentUnits="objectBoundingBox" width="1" height="1">
                    <use xlink:href="#image0_1668_26851"
                        transform="matrix(0.00359712 0 0 0.00719424 0 -0.00359712)">
                    </use>
                </pattern>
    ...
    @if (Route::currentRouteName() == 'home' ||
            Route::currentRouteName() == 'activity' ||
            Route::currentRouteName() == 'promotion' ||
            Route::currentRouteName() == 'wallet'||
            Route::currentRouteName() == 'account')
        <div data-v-67fe8f9c="" class="tabbar__container" style="--36a344b0: 'Roboto', 'Inter', sans-serif;">
            <div data-v-67fe8f9c="" onclick="window.location.href='{{ route('home') }}';"
                class="tabbar__container-item @if (Route::currentRouteName() == 'home') active @endif">
            ...
            <div data-v-67fe8f9c="" class="tabbar__container-item @if (Route::currentRouteName() == 'activity') active @endif"
            ...
            <div data-v-67fe8f9c="" onclick="window.location.href='{{ route('promotion') }}';"
                class="tabbar__container-item @if (Route::currentRouteName() == 'promotion') active @endif">
            ...
            <div data-v-67fe8f9c="" onclick="window.location.href='{{ route('wallet') }}';"
                class="tabbar__container-item @if (Route::currentRouteName() == 'wallet') active @endif">
                <svg data-v-67fe8f9c="" xmlns="http://www.w3.org/2000/svg" width="48" height="48"
            ...
            <div data-v-67fe8f9c="" onclick="window.location.href='{{ route('account') }}';"
                class="tabbar__container-item @if (Route::currentRouteName() == 'account') active @endif">
                <svg data-v-67fe8f9c="" xmlns="http://www.w3.org/2000/svg" width="48" height="48"
                    fill="none" viewBox="0 0 46 44" class="">
                    <circle cx="28" cy="24" r="18" fill="#FFF4F4"></circle>
                    <path fill="#FFCDCB" fill-rule="evenodd"
