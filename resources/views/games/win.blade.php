...
<script>
        ...
        $(document).ready(function () {  $("#saprebalancetop").load('balance.php');
            ...
            $("#sapreansrec").load('sapreansrec.php?spage=1');
...
<body>
    ...
    <div data-v-4c21fa9e="" data-v-f31474c6="" class="navbar">
        <div data-v-4c21fa9e="" class="navbar-fixed wc" style="background: linear-gradient(90deg, rgb(222, 35, 37) 0%, rgb(255, 80, 74) 100%);"><div data-v-4c21fa9e="" class="navbar__content">
    ...
    position: relative;
    z-index: 1;" class="bonus-box">
    <div style="width: 100%;
    height: 100%;
    background: url({{asset('assets/png/UBanner.png')}}) no-repeat 50%;
