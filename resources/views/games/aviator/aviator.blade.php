...
<head>
    ...
    <!--====== Favicon Icon ======-->
    <link rel="shortcut icon" href="{{asset('assets/aviator/images/logo.png')}}" type="image/png" />
...
<body class="dark-bg-main">
    ...
    <header>
        <div class="header-top">
            <div class="header-left">
                <a href="dashboard">
                    <img src="{{asset('assets/aviator/images/logo.svg')}}" class="logo1" />
                </a>
            </div>
                        ...
                        <li>
                            <a href="/crash" class="f-12 justify-content-between">
                                <div class="d-flex align-items-center">
                                    ...
                                    <img src="{{asset('assets/aviator/images/logo.svg')}}" class="side_logo">
                                </div>
                            </a>
                        </li>
        ...
        <div class="header-bottom ">
            <div class="header-left">
                <img src="{{asset('assets/aviator/images/logo.svg')}}" class="logo" />
            </div>
            <div class="header-right d-flex align-items-center">
    ...
    <div class="custom-toaster">
        <div class="cashout-toaster1 ">
            ...
            <div class="got-block position-relative d-flex align-items-center justify-content-center">
                <img src="{{asset('assets/aviator/images/star.svg')}}" class="star-right" />
                <img src="{{asset('assets/aviator/images/star1.svg')}}" class="star-left" />
                <div class="got-amout">
                ...
                <div class="stage-board">
                    ...
                    <div class="loading-game">
                        ...
                        <div class="bottom-left-plane">
                            <img class="plane-static" src="{{asset('assets/aviator/images/p.png')}}" />
                        </div>
                    </div>
                    <img src="{{asset('assets/aviator/images/bg-rotate-old.svg')}}"
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="steps-container">
                        <div class="step step-1">
                            <h3>01</h3>
                            <img src="{{asset('assets/aviator/images/step-01.png')}}" class="w-100" />
                        ...
                        <div class="step step-1">
                            <h3>02</h3>
                            <img src="{{asset('assets/aviator/images/step-02.png')}}" class="w-100" />
                            <div class="step-text pt-2">
                        ...
                        <div class="step step-1">
                            <h3>03</h3>
                            <img src="{{asset('assets/aviator/images/step-03.png')}}" class="w-100" />
                            <div class="step-text pt-2">
                ...
                <audio id="sound_Audio">
                    <source src="{{asset('assets/aviator/mp3/plane-crash.mp3')}}" type="audio/mpeg">
                </audio>
                <audio id="background_Audio">
                    <source src="{{asset('assets/aviator/mp3/background.mp3')}}" type="audio/mpeg">
                </audio>
                <audio id="fly_plane_audio">
                    <source src="{{asset('assets/aviator/mp3/game-start.mp3')}}" type="audio/mpeg">
                </audio>
                <audio id="cash_out_audio">
                    <source src="{{asset('assets/aviator/mp3/cashout.mp3')}}" type="audio/mpeg">
                </audio>
                <audio id="cash_out_audio_2">
                    <source src="{{asset('assets/aviator/mp3/cashout_2.mp3')}}" type="audio/mpeg">
                </audio>
            </div>
        </div>
    </div>
    ...
    <footer>
        <div class="footer-top">
            <a href="dashboard" class="footer-logo"><img src="{{asset('assets/aviator/images/logo.png')}}"
                    class="logo1"></a>
        </div>
        <div class="footer-top">
                ...
                <div class="footer__antillephone-license d-flex align-items-start">
                    <div class="antialis-inner ">
                        <a class="d-flex align-items-start">
                            <img src="{{asset('assets/aviator/images/copyright.png')}}" class="w-100">
