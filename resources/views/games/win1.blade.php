 ...
 */
    ...
    <script>
        ...
        $(document).ready(function () {  $("#beconebalancetop").load('balance.php');
            ...
            $("#beconeansrec").load('beconeansrec.php?spage=1');

setInterval(function () {
    $("#beconeansrec").load('beconeansrec.php?spage=1');
}, 2000);
  $("#beconemybet").load('beconerec.php?srpage=1');
...
console.log(distance);
     ...
     document.getElementById("beconenum9").removeAttribute('disabled');
               ...
               document.getElementById("beconeper").value =    20220474440 ;
               document.getElementById("beconerper").value =    20220474440 ;
               document.getElementById("beconevper").value =    20220474440 ;
               document.getElementById("beconeper1").value =    20220474440 ;
               document.getElementById("beconeper2").value =    20220474440 ;
               document.getElementById("beconeper3").value =    20220474440 ;
               document.getElementById("beconeper4").value =    20220474440 ;
               document.getElementById("beconeper5").value =    20220474440 ;
               document.getElementById("beconeper6").value =    20220474440 ;
               document.getElementById("beconeper7").value =    20220474440 ;
               document.getElementById("beconeper8").value =    20220474440 ;
               document.getElementById("beconeper9").value =    20220474440 ;
               document.getElementById("beconeper0").value =    20220474440 ;
